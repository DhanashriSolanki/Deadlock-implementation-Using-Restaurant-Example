...
public class Chef implements Runnable {
    ...
    /**
     * Java 17 migration: Replaced Arrays.asList() with List.of() (immutable list factory, Java 9+).
     * List.of() returns a truly immutable list (vs Arrays.asList() which allows set() but not add/remove).
     */
    ...
    /**
     * Java 17 migration: Replaced if-else chain with switch expression using arrow syntax (Java 14+).
     * Switch expressions are more concise and exhaustive - the compiler ensures all enum values are handled.
     */
